<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Date label="StartDt" v-model="value.startDt" :editMode="editMode"/>
            <Date label="PickupedDt" v-model="value.pickupedDt" :editMode="editMode"/>
            <Date label="CompDt" v-model="value.compDt" :editMode="editMode"/>
