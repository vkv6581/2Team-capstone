<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            ...
            <Number label="ItemPrice" v-model="value.itemPrice" :editMode="editMode"/>
            ...
            <String label="ItemStatus" v-model="value.itemStatus" :editMode="editMode"/>
            ...
            <Date label="CompltDate" v-model="value.compltDate" :editMode="editMode"/>
        </v-card-text>
