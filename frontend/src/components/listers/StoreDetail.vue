<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <Number label="ItemPrice" v-model="item.itemPrice" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <String label="ItemStatus" v-model="item.itemStatus" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <Date label="CompltDate" v-model="item.compltDate" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
